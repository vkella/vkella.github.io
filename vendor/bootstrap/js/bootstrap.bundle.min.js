...
!function(t, e) {
    ...
    function xt(t, e) {
        ...
        if (t !== l && e !== l || i.contains(r))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && Lt(s.firstElementChild) !== s ? Lt(l) : l;
        var c = Pt(t);
    ...
    function te(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && It(e) && (n.offsets.popper = Kt(n.offsets.popper),
    ...
    var pe = {
        ...
        modifiers: {
                ...
                fn: function(t, i) {
                    ...
                    var c = i.priority
                      ...
                      , h = {
                        primary: function(t) {
                            var e = f[t];
                            return f[t] < l[t] && !i.escapeWithReference && (e = Math.max(f[t], l[t])),
                            Ut({}, t, e)
                        },
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    var n;
                    if (!le(t.instance.modifiers, "arrow", "keepTogether"))
                        return t;
                    var i = e.element;
                    if ("string" == typeof i) {
                    ...
                    t.arrowElement = i,
                    t.offsets.arrow = (Ut(n = {}, h, Math.round(E)),
                    Ut(n, u, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(p, g) {
                    if (ee(p.instance.modifiers, "inner"))
                        return p;
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        p.placement = _ + (E ? "-" + E : ""),
                        p.offsets.popper = Bt({}, p.offsets.popper, Zt(p.instance.popper, p.offsets.reference, p.placement)),
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(t) {
                    if (!le(t.instance.modifiers, "hide", "preventOverflow"))
                        return t;
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    return t.attributes = Bt({}, _, t.attributes),
      ...
      , ge = function() {
        function o(t, e) {
            ...
            Object.keys(Bt({}, o.Defaults.modifiers, i.modifiers)).forEach(function(t) {
        ...
        return Ft(o, [{
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        t.offsets.popper = Zt(this.popper, t.offsets.reference, t.placement),
            ...
            value: function() {
                return function() {
                    ...
                    ee(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
    ...
    Ve = function() {
                ...
                !e) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && me(t).addClass(Ne),
        ...
        ,
        t._getConfig = function(t) {
            return t = c({}, this.constructor.Default, me(this._element).data(), t),
        ...
        t._getPlacement = function() {
            var t = me(this._element).parent()
              , e = He;
            return t.hasClass(De) ? (e = Me,
            me(this._menu).hasClass(Oe) && (e = Re)) : t.hasClass(Ae) ? e = Fe : t.hasClass(Se) ? e = Ue : me(this._menu).hasClass(Oe) && (e = We),
            e
        }
        ,
                ...
                for (var e = me.makeArray(me(ke)), n = 0; n < e.length; n++) {
                    ...
                    if (r) {
                        ...
                        if (me(i).hasClass(Ie) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && me.contains(i, t.target))) {
                            ...
                            me(i).trigger(a),
                            a.isDefaultPrevented() || ("ontouchstart"in document.documentElement && me(document.body).children().off("mouseover", null, me.noop),
    ...
    sn = function() {
        ...
        t.show = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                Qe(this._element).on(Ze.CLICK_DISMISS, on.DATA_DISMISS, function(t) {
                    return e.hide(t)
                }),
        ...
        t._removeBackdrop = function() {
            this._backdrop && (Qe(this._backdrop).remove(),
            this._backdrop = null)
        }
        ,
    ...
    Sn = function() {
        ...
        t.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                an.contains(this.element.ownerDocument.documentElement, this.tip) || an(i).appendTo(a),
                ...
                an(i).addClass(bn),
                "ontouchstart"in document.documentElement && an(document.body).children().on("mouseover", null, an.noop);
                var l = function() {
        ...
        t.hide = function(t) {
            var e = this
              ...
              , r = function() {
                e._hoverState !== _n && n.parentNode && n.parentNode.removeChild(n),
                e._cleanTipClass(),
            ...
            if (an(this.element).trigger(i),
            !i.isDefaultPrevented()) {
                if (an(n).removeClass(bn),
                "ontouchstart"in document.documentElement && an(document.body).children().off("mouseover", null, an.noop),
        ...
        t.getTipElement = function() {
            return this.tip = this.tip || an(this.config.template)[0],
            this.tip
        }
        ,
        ...
        t._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t)
                    an(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                        return i.toggle(t)
                    });
                else if (t !== An) {
        ...
        t._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (an(t).removeClass(yn),
    ...
    Kn = function(t) {
        ...
        r.getTipElement = function() {
            return this.tip = this.tip || On(this.config.template)[0],
            this.tip
        }
        ,
    ...
    ii = function() {
        ...
        t._getConfig = function(t) {
            if ("string" != typeof (t = c({}, zn, "object" == typeof t && t ? t : {})).target) {
                ...
                e || (e = gt.getUID(Qn),
                Vn(t.target).attr("id", e)),
                t.target = "#" + e
            }
            return gt.typeCheckConfig(Qn, t, Xn),
            t
        }
        ,
        ...
        t._activate = function(e) {
            ...
            n.addClass($n)) : (n.addClass($n),
            n.parents(ti.NAV_LIST_GROUP).prev(ti.NAV_LINKS + ", " + ti.LIST_ITEMS).addClass($n),
    ...
    bi = function() {
        ...
        ,
        t.dispose = function() {
            ri.removeData(this._element, oi),
            this._element = null
        }
        ,
    ...
    ri(document).on(li.CLICK_DATA_API, vi, function(t) {
        t.preventDefault(),
        bi._jQueryInterface.call(ri(this), "show")
    }),
